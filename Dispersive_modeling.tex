...
\citet{madsen1992new} \todo{Is it Schaeffer or M and S ? J: same as M\&S(1992) Part2} derived 
...
trough following the crest that surpases the threshold, \todo{G: May have to modify according to new simulations.},
...
we obtain a solid grid convergence for tyhe \BoussClaw model. This is in 
...
dissipation which dominates over the first effects.\todo{Geir: But, Li and Raichlen obtained a smaller runup height; Manning friction ? Check.}   
