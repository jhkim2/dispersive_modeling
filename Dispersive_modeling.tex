...
switched to the shallow water equations for the corresponding wave packet\todo{G: wave packet is too loose. Must specify.},
...
breaking then starts at $x=4.09$\todo{What are the height, time, etc for the BIM simulation}. 
