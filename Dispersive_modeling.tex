...
\marginpar{\footnotesize Move to last part to conclusions?}
...
\marginpar{\footnotesize The use of \citet{schaffer1993boussinesq} and \citet{schaffer1995further} is arbitrary. Suggest that you put in a clear distinction here, i.e. that you derive your eq.s on the basis of these two sets}. 
...
the presentation of the results. \marginpar{\footnotesize Please introduce this first time we use it. Not sure if it is here.} 
