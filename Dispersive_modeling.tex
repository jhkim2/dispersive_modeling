...
\textsc{Funwave-TVD} model shares similarities with \textsc{BoussClaw}, employing a hybrid 
...
which employed $400$ grids. 
%\marginpar{\footnotesize Something missing. 400 points?}
