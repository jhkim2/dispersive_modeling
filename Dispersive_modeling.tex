...
\begin{figure}[tbh!]
	...
	\end{subfigure}
	\caption{Wave energy ($A/h_0=0.28$, slope $1:19.85$) as function of crest position.
		The vertical line is at $x=8.03227$  where $\epsilon_B=0.8$. }
...
\caption{Energy dissipation rates for $A/h_0=0.28$ and a $1:19.85$ slope. The label ``formula'' represents (\ref{eq:energy_dissipation}) inserted the wave heifgts from the numerical simulations.
...
The experiments of \citet{synolakis1987runup} and a full potential reference model
 enabled us to
assess a set of different long wave models, including \BoussClawt. Using the potential  model, we were able to assess in detail the pore-breaking behavior of the models,
